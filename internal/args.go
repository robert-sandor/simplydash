...
type Args struct {
	...
	ConfigFile    string `name:"config"                        help:"Path to config file"         short:"c" required:"" type:"existingfile"`
	ImageCacheDir string `name:"image-cache"                   help:"Path to dir to store images" short:"i"             type:"existingdir"`
	Log           struct {
